...
--
-- Хост: 127.0.0.1
-- Время создания: Май 04 2020 г., 23:16
...
--
-- База данных: `itech2_lw1_v0`
--
CREATE DATABASE IF NOT EXISTS `itech2_lw1_v0` DEFAULT CHARACTER SET cp1251 COLLATE cp1251_general_ci;
USE `itech2_lw1_v0`;
...
(170, 'Dale&nbspCarnegie'),
(171, 'Napoleon&nbspHill');
...
(11, 'The Quick and Easy Way to Effective Speaking', NULL, 1990, 'Pocket&nbspbooks', '978-0671724009', NULL, 224, 'Book', NULL),
(12, 'How to Stop Worrying and Start Living', NULL, 1990, 'Pocket&nbspbooks', '978-0671733353', NULL, 352, 'Book', NULL),
(13, 'The Law of Success : In Sixteen Lessons', NULL, 2011, 'Wilder&nbspPublications', '978-1617201769', NULL, 548, 'Book', NULL),
